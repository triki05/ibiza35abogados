	...
	<div class="row">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a href="{{route('nuevoCliente')}}">Nuevo</a>
			</ol>
		</nav>
	</div>
</div>
		...
		<div class="col-10 offset-1">
    		<div class="card">
    			...
    			<div class="card-body">
            		...
            		@endif
    				<form action="{{route('save-cliente')}}" method="post" class="form-inline">
    				{!! csrf_field() !!}
    					@if($errors->has())
    					...
    					<div class="input-group col-md-6">
    						<a href="{{url('/menu-clientes')}}" class="btn btn-danger">Volver</a>
    					</div>
    				</form>
    			</div>
    		</div>
