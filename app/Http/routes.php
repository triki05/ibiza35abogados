...
Route::group(['middleware' => ['auth']], function () {
	...
	Route::get('/menu-tribunales/editar/{id}', [
		'as' => 'edit-tribunal',
		'uses' => 'TribunalesController@editTribunal'
	]);

	Route::post('/menu-tribunales/editar/update/{id}', [
		'as' => 'update-tribunal',
		'uses' => 'TribunalesController@update'
	]);
	...
	Route::get('/menu-casos/caso/new-fase-general/{num}/{caso_id}/{cliente_id}', [
		'as' => 'new-fase-general',
		'uses' => 'CasosController@newFaseGeneral'
	]);

	//Actualizar fase
	Route::post('/menu-casos/caso/update-fase/{id}', [
		'as' => 'caso-update-fase',
		'uses' => 'FaseController@update'
	]);

	//Nueva fase
	Route::get('/menu-casos/caso/new-fase/{num_fase}/{descriptor}/{caso_id}', [
		'as' => 'new-fase-caso',
		'uses' => 'FaseController@new'
	]);

	//Documentos
	Route::get('/menu-casos/caso/documentos/{id_caso}', [
		'as' => 'view-documents',
		'uses' => 'CasosController@viewDocuments'
	]);
